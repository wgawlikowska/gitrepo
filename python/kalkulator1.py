...
def main(args):
    ...
    while True:
        ...
        if d == '+':
            ...
            a= pobierz_liczbe(komunikat='Podaj kąt w stapniach:')
            if not isinstance(a,(bool)):
                print('sin({})'={}(format(a,sinus(a)))
            
        elif d == 'cos':
            a = pobierz_liczbe(komunikat='Podaj kąt w stopniach:')
            if not isinstance(a,(bool)):
                print('cos({})'={}(tormat(a,sinus(a))))
            pass
        elif d == 'l':
            pokaz_liste()
        elif d == 'koniec':
